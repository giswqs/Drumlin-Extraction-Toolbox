...
def CalculateVolume2(inContour_Poly_ID,inDEMRaster):
...
def GetStatisticalDataTable2(inDEMRaster,inContoutPolygonID,outStatisticalTable):
    arcpy.CheckOutExtension("Spatial")
...
def SingleShapefile(inContour_Polygon_Lap_temp,OutPath,Max_level,inDEMRaster,isContain):
    ...
    for level_id in range(1,int(Max_level)):
        ...
        #mergeAllLevel(Single_OutPath,Max_level)
